...
class WANDBExperiment(Task):
    ...
    def process(self):
        ...
        run_obj = wandb.init(id = wandb_id, name=experiment_name, project=project_name, notes=description, config=self.config, resume='allow', mode='offline')
    ...
    def find_cache(self):
        ...
        if cache_paths and self.cache:
            ...
            wandb.init(id = wandb_id, name=experiment_name, project=project_name, notes=description, config=self.config, resume=wandb_id, mode='offline')
